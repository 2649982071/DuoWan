...
//@class TuWanVideoEsArrayModel,TuWanVideoContentModel,TuWanVideoRelevantModel;
@class TuWanVideoEsArrayModel,TuWanVideoContentModel,TuWanVideoRelevantModel;
@interface TuWanVideoModel : BaseModel

@property (nonatomic, strong) NSArray<TuWanVideoEsArrayModel *> *esArray;

@end

@interface TuWanVideoEsArrayModel : NSObject
